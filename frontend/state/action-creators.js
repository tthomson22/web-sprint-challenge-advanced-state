...
export function moveClockwise(moved) {
  return{type: MOVE_CLOCKWISE, payload: moved}
}

export function moveCounterClockwise(moved) {
  return{type: MOVE_COUNTERCLOCKWISE, payload: moved}
}
